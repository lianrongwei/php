      ...
      <form class="row" action="$_SERVER['PHP_SELF'];" method="post" enctype="multipart/form-data">
        <div class="col-md-9">
          ...
          <div class="form-group">
            ...
            <!-- <textarea id="content" class="form-control input-lg" name="content" cols="30" rows="20" placeholder="内容"></textarea> -->
            <script id="content" name="content" type="text/plain">初始值</script>
          </div>
        </div>
        <div class="col-md-3">
          <div class="form-group">
